...
namespace Player
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        [Tooltip("Player Input component")] [SerializeField]
...
#if !ENABLE_INPUT_SYSTEM
			Debug.LogError( "New Input System package is not configured for this project");
#endif
        ...
        private void Move()
        {
            ...
            float inputMagnitude = !_canMove ? 0f : _input.analogMovement ? _input.move.magnitude : 1f;
            ...
            Vector3 inputDirection =
                _canMove ? new Vector3(_input.move.x, 0.0f, _input.move.y).normalized : Vector3.zero;
